...
| ES | [Direct Eight Sleep recovery ingestion](./eight-sleep-direct-recovery-ingestion.md) | **In progress (default-off)** | ES9 (shadow direct-vs-Google comparison) | ES9 needs an accumulation window; ES10 needs that plus prospective evidence | owned direct read-only recovery connector for Eight Sleep (ADR-0030); ES8's real-account probe ran 2026-08-28 |
