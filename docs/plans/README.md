...
| UX-R | [Mobile UX remediation: interaction, overlays, and navigation](./2026-09-mobile-ux-remediation.md) | **Approved** | none until the delivery sequence is agreed | plan approval; implementation items are the existing open GitHub issues #727–#732 | coordinates the mobile interaction, overlay, navigation, and E2E work without reopening the implemented redesign |
