...
| 6 | [Evidence-driven calibration & operational assurance](./phase-6-evidence-and-operational-assurance.md) | **In progress** | **6.4, 6.6** | 6.5 needs Firebase owner/project; 6.7 needs 6.4 evidence; 6.2c's baseline acceptance is blocked (see below) | remaining F11, F12, F15 |
