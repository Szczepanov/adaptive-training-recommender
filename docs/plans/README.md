...
provider-neutral contracts and HRF2's MIT-licensed, target-only FIT ingestion boundary are
complete; production gating remains separately evidence-gated after replay.
