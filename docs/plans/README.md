...
| NTA | [Previous-day calorie tracking scoring](./previous-day-calorie-tracking-scoring.md) | **Implemented in PR #710 (pending merge)** | none | merge + CI closure | optional D-1 behavioral logging-quality context, strict missing-vs-zero semantics, validated retrospective D+1 reads, and full-day-fast contradiction visibility; ADR-0042 recommendation authority remains zero |
...
Rows G, HRF, S, M, CT, WU, UX, OV, HA, SV, MS, PI, ES, TO, SEP, SKR, BC, NTA, SAW, RP, and PG are **not phases**. They are capability/surface plans whose work items are
