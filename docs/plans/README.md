...
| 6 | [Evidence-driven calibration & operational assurance](./phase-6-evidence-and-operational-assurance.md) | **In progress** | none | 6.5 needs Firebase owner/project; 6.7 needs a reproducible undesirable fatigue trajectory; 6.2c's baseline acceptance is blocked (see below) | remaining F11, F12, F15 |
