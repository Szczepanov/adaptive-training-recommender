...
Rows G, HRF, S, M, CT, WU, UX, UX-R, OV, HA, SV, MS, PI, ES, TO, SEP, SKR, BC, NTA, SAW, RP, and PG are **not phases**. They are capability/surface plans whose work items are
prefixed `G*`, `HRF*`, `S*`, `M*`, `CT*`, `WU*`, `UX*`, `UX-R*`, `OV*`, `HA*`, `SV*`, `MS*`, `PI*`, `ES*`, `TO*`, `SEP-*`, `SKR*`, `BC*`, `SAW*`, `RP*`, and `PG*` precisely so they cannot be mistaken for the `Phase 0`–`9`
