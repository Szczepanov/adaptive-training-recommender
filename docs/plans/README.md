...
| 9 | [Subjective baselines in readiness mode](./phase-9-subjective-baselines.md) | **In progress** | 9.1 (9.5 done; ADR-0020 accepted, so 9.1 is now unblocked — 9.2/9.3/9.4/9.6/9.7 each still wait on an earlier item in this same plan, and 9.8 additionally needs Phase 9.0's prospective evidence) | — | self-normalises subjective scores as a tighten-only drift term, measured behind a default-off selector before any ship decision — not an original review finding |
