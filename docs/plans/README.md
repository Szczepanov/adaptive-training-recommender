...
**In progress**: HRF0's real-account FIT provenance/decoder spike and HRF1's
...
separately evidence-gated after replay. Training occurrence reconciliation (TO) is **in
...
| MS | [Multisource health & recovery ingestion](./multisource-health-and-recovery-ingestion.md) | **In progress** | MS17 | MS17 needs CASA Tier 2 / Restricted Scope Verification and prospective evidence | source-aware observation contract, Google Health ingestion, Eight Sleep export probing, and evidence-gated fusion (ADR-0027); MS0–MS16, MS18, MS19 done, only MS17's production-activation decision remains |
