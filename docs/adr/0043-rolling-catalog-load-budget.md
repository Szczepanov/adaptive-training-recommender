...
envelope uses the existing six catalog cost dimensions and a seven-day fixed forecast horizon.
With at least three completed exposures spanning at least fourteen calendar days in the stable
pre-window, limits are derived from the athlete's own thirty-five-day baseline with fifteen
percent headroom. Sparse history leaves this new gate inactive; existing fatigue, readiness,
clinical, injury, schedule, fixed-activity and authored-plan authorities remain in force.
