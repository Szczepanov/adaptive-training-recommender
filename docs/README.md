...
* [**ADR-0034: Canonical Performed Training Occurrence and Multisource Reconciliation**](./adr/0034-canonical-performed-training-occurrence-and-multisource-reconciliation.md) — *Proposed.* Introduces `PerformedTrainingOccurrence` as the single canonical performed-workout record reconciling `SessionExecution` and provider (Garmin) evidence, distinct from `SessionOccurrence`'s planning authority; implementation landed in [PR #324](https://github.com/Szczepanov/adaptive-training-recommender/pull/324), merged 2026-09-02. The Activities read model remains flag-gated, while weekly coverage credit later cut over via [PR #331](https://github.com/Szczepanov/adaptive-training-recommender/pull/331).
...
* [**ADR-0036: Intraday Training Windows and Post-Session Reassessment**](./adr/0036-intraday-training-windows-and-reassessment.md) — *Accepted, implemented.* Explicit windows, v4-authored sequencing, shared daily accounting and post-AM reassessment are live; automatic generated multi-window packing remains deferred and must reuse those contracts.
...
* [**2026-08-27 Physiological Identity Passport & Measurement Trust**](./analysis/2026-08-27-physiological-identity-passport-and-measurement-trust.md) — Shared-source recovery observations and measurement trust analysis.
...
* [**2026-09-20 Issue #676 remediation — hard-load density and race-week sequencing**](./analysis/2026-09-20-hard-load-density-and-race-week-sequencing.md) — Confirms the whole-horizon recent-load and Priority-A race-week interaction gaps, adds bounded taper sharpening during severe-recovery re-entry, and records why no universal 3/4-day concurrent-strength spacing rule was added.
* [**2026-09-20 Whole-horizon fatigue-tier rebound**](./analysis/2026-09-20-whole-horizon-fatigue-tier-rebound.md) — Confirms the shared #676/#677 fatigue-tier rebound mechanism; issue #692 resolves cross-counterfactual whole-horizon monotonicity as a planner non-invariant while explicitly retaining local safety/ranking contracts and treating projected fatigue as an uncalibrated product model rather than a physiological measurement.
...
* [**Phase 9.0: Shadow mode and the decision journal**](./plans/phase-9-0-shadow-mode-and-decision-journal.md) — *In progress.* 9.0.1 unattended ingestion is closed and 9.0.2–9.0.6 are complete; 9.0.7 is startable now, while the prospective multi-week block and 9.0.8 analysis/readout remain.
