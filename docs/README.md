...
* [**Activity heart-rate measurement fidelity**](./plans/activity-heart-rate-measurement-fidelity.md) — *Approved.* HRF0 confirms the original-download/decoder boundary and HRF1 adds provider-neutral contracts; HRF2 awaits the FIT SDK licensing decision.
