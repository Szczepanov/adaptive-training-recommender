...
* [**2026-09-24 Hybrid tissue re-entry and weekly strength preservation**](./analysis/2026-09-24-hybrid-tissue-reentry-strength-preservation.md) — Separates exact primary-strength role credit from tier-2 symptom-compatible resistance support, with matched counterfactual judge coverage, allocation-report UI visibility, and ADR-0033 product-policy lineage.
