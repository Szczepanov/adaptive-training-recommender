...
* [**Activity heart-rate measurement fidelity**](./plans/activity-heart-rate-measurement-fidelity.md) — *Approved.* HRF0–HRF2 establish the original-download, MIT-licensed decoder, canonical-contract, and target-only shadow-ingestion boundaries; production gating remains evidence-gated.
