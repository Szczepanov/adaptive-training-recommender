...
* [**ADR-0031: Activity Heart-Rate Measurement Fidelity and Evidence Authority**](./adr/0031-activity-heart-rate-measurement-fidelity-and-evidence-authority.md) — *Proposed.* Separates HR sensor/source provenance from technical signal quality and makes downstream authority use-case-specific; low measurement confidence removes or bounds evidence rather than lowering athlete readiness.
...
* [**Activity heart-rate measurement fidelity**](./plans/activity-heart-rate-measurement-fidelity.md) — *Draft.* `HRF*` capability for FIT-based HR source provenance, deterministic trace-quality diagnostics, use-case-specific HR authority, shadow replay, and evidence-gated production activation (ADR-0031 proposed).
