...
* [**2026-09-20 Whole-horizon fatigue-tier rebound**](./analysis/2026-09-20-whole-horizon-fatigue-tier-rebound.md) — Confirms recentLoadHorizonDensity.test.ts's monotonicity finding shares the identical root cause as #677/#684's conservativeBias Mechanism B (resting more early unlocks a higher, uncapped fatigue tier later); resolved under issue #692 with whole-horizon counterfactual monotonicity accepted as an intentional characteristic of greedy local fatigue-tier evaluation.
