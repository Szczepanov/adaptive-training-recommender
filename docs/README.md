...
* [**ADR-0035: Explicit Rest-Day Authoring in External Plans**](./adr/0035-explicit-rest-day-authoring.md) — *Proposed.* Distinguishes a plan author's deliberate protected rest day from an ordinary unplanned date (both currently resolve identically to an evergreen fallback); presents three schema options and rejects one as insufficient before implementation begins. Not implemented.
---
