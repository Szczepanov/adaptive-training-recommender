...
* [**ADR-0012: Plan Intent Is the Planning Authority**](./adr/0012-plan-intent-authority.md) — `PlanDefinition` and sequence planning collapse the two selection paths into one training authority (Phase 2).
...
* [**2026-08-11 Phase 6 & 7 compliance review**](./analysis/2026-08-11-phase-6-7-completion-review.md) — Code, test, simulation, deployment, and plan-status review of the delivered Phase 6 and Phase 7 work.
