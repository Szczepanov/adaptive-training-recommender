...
- **Research first**: Use search, read, and inspection tools to understand the codebase. When a plan depends on an external package/API contract, use Context7 for current version-appropriate docs; repository-internal behavior still comes from the code/docs.
