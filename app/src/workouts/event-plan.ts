...
export const EVERGREEN_SESSION_COVERAGE: PlanSessionCoverage[] = [
  ...
  { key: 'recovery_or_rest', label: 'Recovery or rest', phases: ['general'], requirement: 'required', workoutIds: ['recovery_mobility_tissue_01', 'recovery_breathwork_01', 'cycling_recovery_spin_01', 'rest_complete_01'], notes: 'Supports active and passive recovery choices without creating aerobic or strength credit.' },
