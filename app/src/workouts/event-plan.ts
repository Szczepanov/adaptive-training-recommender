...
export const SEPTEMBER_CYCLING_EVENT_SESSION_COVERAGE: PlanSessionCoverage[] = [
  { key: 'aerobic_volume', label: 'Easy Zone 2 aerobic volume', phases: ['build', 'travel', 'peak', 'taper', 'recovery'], requirement: 'required', workoutIds: ['cycling_zone2_standard_01'], notes: 'Counts only the authored Zone 2 prescription at or above the athlete-relative aerobic-volume floor (the catalog minimum until 28-day history supports a higher one, #757); a recovery spin never replaces this floor.' },
