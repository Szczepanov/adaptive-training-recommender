    ...
    const handleFinish = async () => {
        ...
        try {
            ...
            await Promise.all([
                ...
                trainingSettingsService.updateTrainingSettings(userId, {
                ...
                {step === 2 && (
                    <div className="onboarding-step step-2">
                        ...
                        <div className="choice-grid">
                            <button
                                type="button"
                                className={`choice-card ${focus === 'general_fitness' ? 'active' : ''}`}
                                onClick={() => setFocus('general_fitness')}
                            >
                            ...
                            <button
                                type="button"
                                className={`choice-card ${focus === 'running_10k_half' ? 'active' : ''}`}
                                onClick={() => setFocus('running_10k_half')}
                            >
                                <span className="choice-icon">🏃</span>
                            ...
                            <button
                                type="button"
                                className={`choice-card ${focus === 'cycling' ? 'active' : ''}`}
                                onClick={() => setFocus('cycling')}
                            >
                                <span className="choice-icon">🚴</span>
                            ...
                            <button
                                type="button"
                                className={`choice-card ${focus === 'strength' ? 'active' : ''}`}
                    ...
                    <div className="onboarding-step step-3">
                        ...
                        <div className="choice-group">
                            ...
                            <div className="choice-grid-small">
                                <button
                                    type="button"
                                    className={`choice-card-mini ${equipment === 'full_gym' ? 'active' : ''}`}
                                    onClick={() => setEquipment('full_gym')}
                                >
                                    🏋️ Full Gym (Barbells, Machines, Cardio)
                                </button>
                                <button
                                    type="button"
                                    className={`choice-card-mini ${equipment === 'home_dumbbells' ? 'active' : ''}`}
                                    onClick={() => setEquipment('home_dumbbells')}
                                >
                                    🏠 Home Gear (Dumbbells & Pull-up Bar)
                                </button>
                                <button
                                    type="button"
                                    className={`choice-card-mini ${equipment === 'minimal' ? 'active' : ''}`}
                                    onClick={() => setEquipment('minimal')}
                                >
                            ...
                            <div className="days-selector-row">
                                {[3, 4, 5, 6].map(days => (
                                    <button
                                        key={days}
                                        type="button"
                                        className={`days-pill ${daysPerWeek === days ? 'active' : ''}`}
