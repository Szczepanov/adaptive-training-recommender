...
describe('creditObjectivesFromStimulus (regression: the split-brain ledger bug)', () => {
  const zeroStimulus: WorkoutStimulusProfile = {
    aerobicEndurance: 0, thresholdPower: 0, vo2MaxPower: 0, repeatedSurges: 0, sprintPower: 0, maxStrength: 0, hypertrophy: 0, fatigueResistance: 0,
  };
...
describe('structured completed-history credit', () => {
  it('uses structured evidence rather than a loose activity title when rebuilding a microcycle', () => {
    ...
    const exposure: CompletedExposure = {
      ...
      modality: 'Cycling',
      stimulusProfile: { aerobicEndurance: 0.7, thresholdPower: 0.5, vo2MaxPower: 0, repeatedSurges: 0.5, sprintPower: 0, maxStrength: 0, hypertrophy: 0, fatigueResistance: 0 },
    };
...
describe('Task 1.2 / F2 Garmin objective crediting', () => {
  ...
  it('prefers the exact template stimulus profile for adherence-followed exposures', () => {
    const exposure: CompletedExposure = {
      ...
      stimulusProfile: { aerobicEndurance: 0.9, thresholdPower: 0.1, vo2MaxPower: 0, repeatedSurges: 0, sprintPower: 0, maxStrength: 0, hypertrophy: 0, fatigueResistance: 0 },
    };
