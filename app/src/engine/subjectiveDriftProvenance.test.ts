...
function snapshot() {
    return buildTrainingHistorySnapshot('2026-08-16', 7,
...
function recommendation(): Recommendation {
    ...
    return {
        ...
        decisionTrace: { policyVersion: POLICY_VERSION, candidateScores: [{ templateId: template.id, utilityScore: 1, excludedReasons: [] }], droppedContributorObjectives: [] },
    };
}
const evidence: SubjectiveDriftDecisionEvidence = {
    estimatorId: 'subjective-baseline-v1-mean-stdev-7-28', historyThroughDateExclusive: '2026-08-16', recentRecordedDays: 6, longRecordedDays: 23,
    contribution: 1.25,
