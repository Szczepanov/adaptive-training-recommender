...
describe('isHistoricalPolicyVersion', () => {
    it('records the current transition and the previous live policies exactly once', () => {
        expect(POLICY_VERSION).toBe('2026-09-strength-full-body-reentry-catalog-v1');
        expect(HISTORICAL_POLICY_VERSIONS[0]).toBe('2026-09-strength-deferral-forecast-credit-aging-v1');
