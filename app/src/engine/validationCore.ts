...
export function validateGoal(raw: any): ValidationResult<UserGoal> {
    ...
    // create/update boundary: validationCore.ts is reachable from production
...
export function validatePreferences(raw: any): ValidationResult<UserPreferences> {
    ...
    if (raw.unavailableModalities !== undefined) {
        const validUnavailableModalities = ['Running', 'Cycling', 'Swimming', 'Walking', 'Strength', 'Field', 'Mobility', 'Cross Training', 'Rowing'];
