...
describe('engine knowledge coverage inventory', () => {
    ...
    it('reports coverage and risk debt after the #758, #809 and #800 policies', () => {
        ...
        expect(summary.byCoverage).toEqual({ covered: 53, partial: 18, uncovered: 1, not_applicable: 6 });
        expect(summary.byPriority).toEqual({ p0: 8, p1: 9, p2: 2, p3: 0, none: 59 });
