...
export const SPORTS_KNOWLEDGE_CLAIMS: readonly KnowledgeClaim[] = [
    ...
    },
    {
        ...
        limitations: ['This is a product ranking and recovery heuristic, not evidence that walking or cycling is universally superior to running.', 'The Hard Endurance ceiling and one-session/seven-day boundary are conservative calibration values and do not establish universal physiological maximums.', 'An explicit running preference, explicit endurance/speed-power/sport-readiness priority, event-directed mode or separate clinical guidance can change the appropriate plan.'],
