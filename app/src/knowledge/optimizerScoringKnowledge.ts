...
export const OPTIMIZER_SCORING_CLAIMS: readonly KnowledgeClaim[] = [
    ...
    },
    {
        ...
        statement: 'Product rolling-load budget v1: when at least 3 completed exposures span at least 14 calendar days in the stable 42-day pre-window, the planner derives a per-athlete seven-day future catalog-cost envelope from that athlete\'s own weekly baseline with 15% headroom. Each dimension uses the greater of that individualized value and product floors of systemic 2.0, cardiovascular 3.0, lower-body 2.0, upper-body 2.0, impact-tissue 2.0 and neuromuscular 2.0. The seven-date accounting horizon begins tomorrow. The already-computed day-1 provisional recommendation is charged to that envelope but remains selected by the separate next-day evaluator; planner-generated day-2+ projected exercise candidates are gated using the dose actually prescribed. Fixed-activity and schedule-overlay expected costs reserve the same horizon envelope without being reclassified as completed training. Clinical, injury and readiness authorities remain independent, and sparse history leaves the new gate inactive.',
