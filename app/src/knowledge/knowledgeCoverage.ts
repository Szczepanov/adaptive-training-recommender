...
export const ENGINE_KNOWLEDGE_COVERAGE: readonly EngineKnowledgeCoverageItem[] = [
    ...
    },
    {
        ...
        coverageRationale: 'The weekly target/cap and one-reservation transactional allocation rule are registered as product policy. Qualification thresholds are inventoried separately; the credit follows the current aerobic role dose and the underlying WHO aerobic requirement is not rewritten.',
    },
    {
