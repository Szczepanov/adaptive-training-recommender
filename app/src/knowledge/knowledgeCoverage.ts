...
export const ENGINE_KNOWLEDGE_COVERAGE: readonly EngineKnowledgeCoverageItem[] = [
    ...
    },
    {
        ...
        currentRule: 'For an A-priority Olympic triathlon with at least three measured pre-taper swim/bike/run sessions spanning seven days, the final 14-day as-of plan caps projected upper-bound minutes plus delivered minutes at 0.59 of the prior 14-day recorded minutes and session count at the ceiling of 0.85 of the prior count, with a three-session floor. Dated pending fixed training with exact or authored identity also reserves its stated minutes and session slot, including future dates. Each seven-day block spends at most half the minute allowance and half the session allowance, rounded up. A balanced baseline reserves a 30-minute swim and a bike and run touch per block where feasible; 30 cycling and 25 running minutes are reserved for D-4 through D-2, and race-week swim is limited to 45 minutes. D-1 is rest.',
        classification: 'product_heuristic', coverage: 'partial', decisionImpact: 'high', safetyImpact: 'moderate', researchPriority: 'p1',
