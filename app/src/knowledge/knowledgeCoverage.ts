...
export const ENGINE_KNOWLEDGE_COVERAGE: readonly EngineKnowledgeCoverageItem[] = [
    ...
    },
    {
        ...
        currentRule: 'For event-free health plans without explicit running support, Walking/Cycling receive a soft aerobic ranking preference; Hard Endurance is withheld as generic quality filler, Moderate Endurance remains available, quality endurance is limited to one prior session in a rolling seven-day window, and adverse-recovery forecasts withhold quality endurance until the next fresh planning check. Running remains available at non-hard intensity and strength requirements are unchanged.',
        ...
        coverageRationale: 'Registered as an explicit product-policy claim (`health.adherence.modality_intensity_prior_v1`) based on deterministic persona evidence and refined by issue #699. It is intentionally narrow, preserves explicit user preference and event-directed authority, and only hard-gates unrequested Hard Endurance quality filler.',
    },
    {
