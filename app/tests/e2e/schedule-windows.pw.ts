...
test('an athlete can add, edit and delete a training window from the Plan screen', async ({ page }) => {
  ...
  // Edit the first window's time and confirm the change persists and re-renders.
